...
--
-- Dumping data untuk tabel `cash_ledger` (total baris: 4)
--
...
--
-- Dumping data untuk tabel `item_stocks` (total baris: 18)
--
...
(11111,123456789,1111,'pcs','pcs',11000,13750,13200,12650,12100,1,'2025-11-04 02:57:53','2025-11-07 11:33:20'),
(123,12345,'BIMOLI 100 ML','pcs','pcs',1500,2500,2250,2000,1750,10,'2025-11-04 02:34:57',NULL),
(1234,123456,'nutisari','pcs','pcs',1500,1875,1800,1725,1650,10,'2025-11-04 02:36:47',NULL),
(12345,NULL,'BIMOLI 100 ML','pcs','pcs',1500,2500,2250,2000,1750,10,'2025-11-04 02:32:21',NULL),
(123456,654321,'kola kola','pcs','pcs',3,7,6,4,3,9,'2025-11-04 02:51:55',NULL),
(123456789,987456,'akua','pcs','pcs',2000,2000,2000,2000,2000,10,'2025-11-04 02:59:35','2025-11-07 11:37:20'),
(4321,98765,'mentos','pcs','pcs',1000,2000,1500,1250,1100,10,'2025-11-04 02:54:34',NULL),
(444,234,'ddd','kg','pcs',2,6,5,4,3,10,'2025-11-04 02:48:19',NULL),
(5555,5555,'akua',NULL,'dus',23000,25000,24500,24000,23499,4,'2025-11-07 09:11:32','2025-11-07 11:33:03'),
...
(2,'0001','Fathir','umum','Gumelar','',0,'2025-11-03 03:38:21','085875099445',310),
(3,'002','amir','grosir','jl jalan','',0,'2025-11-07 09:30:43','058575099445',2010),
(4,'0023','WAHYONO','umum','jlnnnnn','',0,'2025-11-07 12:23:26','058575099445',1113),
...
--
-- Dumping data untuk tabel `purchase_items` (total baris: 15)
--
...
--
-- Dumping data untuk tabel `purchases` (total baris: 16)
--
...
--
-- Dumping data untuk tabel `sale_items` (total baris: 104)
--
...
--
-- Dumping data untuk tabel `sales` (total baris: 63)
--
...
(1,'PELANGI MART','Cinurug Rt 06 Rw 06, Gumelar, Kec. Gumelar, Kabupaten Banyumas, Jawa Tengah 53165','085875099445','Terima kasih telah berbelanja.','/tokoapp/uploads/logo_20251102_125050.jpg','PEL/','2025-11-02',10,0,15000,10000,100,25,'https://api.qrserver.com/v1/create-qr-code/?size=140x140&data=',100,25);
...
--
-- Dumping data untuk tabel `stock_mutations` (total baris: 6)
--
