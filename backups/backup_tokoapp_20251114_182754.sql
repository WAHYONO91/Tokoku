...
(11111,123456789,1111,'pcs','pcs',12500,15625,15000,14375,13750,1,'2025-11-04 02:57:53','2025-11-07 11:33:20'),
...
(3,'002','amir','grosir','jl jalan','',0,'2025-11-07 09:30:43','058575099445',1011),
(4,'0023','WAHYONO','umum','jlnnnnn','',0,'2025-11-07 12:23:26','058575099445',88),
...
--
-- Dumping data untuk tabel `purchase_items` (total baris: 21)
--
...
--
-- Dumping data untuk tabel `purchases` (total baris: 22)
--
...
--
-- Dumping data untuk tabel `sale_items` (total baris: 127)
--
...
--
-- Dumping data untuk tabel `sales` (total baris: 75)
--
...
--
-- Dumping data untuk tabel `stock_mutations` (total baris: 7)
--
